...
<section class="bg-gray-300 py-8 antialiased dark:bg-gray-900 md:py-12">
  <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
    <!-- Heading & Filters -->
    <div class="mb-4 px-8 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
      <div>
          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
              <div class="flex items-center">
                ...
                <span class="ms-1 ml-4text-sm font-medium text-gray-500 dark:text-gray-400 md:ms-2">The Menu</span>
              </div>
            </li>
          </ol>
        </nav>
    ...
    <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
      <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="h-56 w-full">
          <a href="#">
            <img class="mx-auto h-full dark:hidden" src="images/calamari.jpg" />
        ...
        <div class="pt-6">
          <div class="mb-4 flex items-center justify-between gap-4">
            <span class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300"> Up to 20% off Monday's </span>
          ...
          <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Calamari Plate</a>
          ...
          <div class="mt-4 flex items-center justify-between gap-4">
            <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">$35.75</p>
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="h-56 w-full">
          <a href="#">
            <img class="mx-auto h-full dark:hidden" src="images/beignet.png" alt="Beignets" />
        ...
        <div class="pt-6">
          <div class="mb-4 flex items-center justify-between gap-4">
            <span class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300"> Up to 20% off Tuesday's </span>
          ...
          <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Beignets</a>
          ...
          <div class="mt-4 flex items-center justify-between gap-4">
            <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">$5.95</p>
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="h-56 w-full">
          <a href="#">
            <img class="mx-auto h-full dark:hidden" src="images/burntends.png" alt="" />
        ...
        <div class="pt-6">
          <div class="mb-4 flex items-center justify-between gap-4">
            <span class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300">Up to 20% off Wednesday's</span>
          ...
          <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Burnt Ends Snack Box</a>
          ...
          <div class="mt-4 flex items-center justify-between gap-4">
            <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">$108.99</p>
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        ...
        <div class="pt-6">
          <div class="mb-4 flex items-center justify-between gap-4">
            <span class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300"> Up to 30% off Thursday's </span>
          ...
          <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">100 pcs Chili Ribs</a>
          ...
          <div class="mt-4 flex items-center justify-between gap-4">
            <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">$98.95</p>
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="h-56 w-full">
          <a href="#">
            <img class="mx-auto h-full dark:hidden" src="images/breadsandwich.jpg" alt="" />
        ...
        <div class="pt-6">
          <div class="mb-4 flex items-center justify-between gap-4">
            <span class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300">Buy 2 get one free from open to close of Friday. </span>
          ...
          <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Gravy Bread Sandwich</a>
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="h-56 w-full">
          <a href="#">
            <img class="mx-auto h-full dark:hidden" src="images/dessert7.png" alt="" />
        ...
        <div class="pt-6">
          <div class="mb-4 flex items-center justify-between gap-4">
            <span class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300"> Up to 20% off Saturday's </span>
          ...
          <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Italian Ice</a>
          ...
          <div class="mt-4 flex items-center justify-between gap-4">
            <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">$175.95</p>
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="h-56 w-full">
          <a href="#">
            <img class="mx-auto h-full dark:hidden" src="images/fatbowl.jpg" alt="" />
        ...
        <div class="pt-6">
          <div class="mb-4 flex items-center justify-between gap-4">
            <span class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300"> Up to 20% off Sunday's </span>
          ...
          <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">The Big Crenny </a>
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="h-56 w-full">
          <a href="#">
            <img class="mx-auto h-full dark:hidden" src="images/yeschef.jpg" alt="" />
        ...
        <div class="pt-6">
          ...
          <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Chef Darlene Gautier'd Dinner Parties</a>
          ...
          <div class="mt-4 flex items-center justify-between gap-4">
            <p class="text-2xl font-semibold leading-tight text-red-500 dark:text-white">$75/hr plus food costs. Call for a Quote!</p>
        ...
        <div class="px-4 md:px-5">
          <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
            <ul class="-mb-px flex flex-wrap text-center text-sm font-medium" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
              ...
              <li class="mr-1" role="presentation">
                <button class="inline-block px-2 pb-2 hover:border-gray-300 hover:text-gray-600 dark:hover:text-gray-600" id="advanced-filers-tab" data-tabs-target="#advanced-filters" type="button" role="tab" aria-controls="advanced-filters" aria-selected="false">Advanced Filters</button>
              </li>
            </ul>
          </div>
          <div id="myTabContent">
            <div class="grid grid-cols-2 gap-4 md:grid-cols-3" id="brand" role="tabpanel" aria-labelledby="brand-tab">
              <div class="space-y-2">
                ...
                <div class="flex items-center">
                  ...
                  <label for="apple" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Apple (56) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="asus" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Asus (97) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="acer" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Acer (234) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="allview" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Allview (45) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="asus" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Atari (176) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="amd" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> AMD (49) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="aruba" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Aruba (16) </label>
                </div>
              </div>
              ...
              <div class="space-y-2">
                ...
                <div class="flex items-center">
                  ...
                  <label for="beats" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Beats (56) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="bose" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Bose (97) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="benq" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> BenQ (45) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="bosch" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Bosch (176) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="brother" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Brother (176) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="biostar" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Biostar (49) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="braun" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Braun (16) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="blaupunkt" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Blaupunkt (45) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="benq2" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> BenQ (23) </label>
                </div>
              </div>
              ...
              <div class="space-y-2">
                ...
                <div class="flex items-center">
                  ...
                  <label for="canon" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Canon (49) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="cisco" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Cisco (97) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="cowon" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Cowon (234) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="clevo" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Clevo (45) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="corsair" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Corsair (15) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="csl" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Canon (49) </label>
                </div>
              </div>
              ...
              <div class="space-y-2">
                ...
                <div class="flex items-center">
                  ...
                  <label for="dell" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Dell (56) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="dogfish" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Dogfish (24) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="dyson" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Dyson (234) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="dobe" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Dobe (5) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="digitus" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Digitus (1) </label>
                </div>
              </div>
              ...
              <div class="space-y-2">
                ...
                <div class="flex items-center">
                  ...
                  <label for="emetec" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Emetec (56) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="extreme" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Extreme (10) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="elgato" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Elgato (234) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="emerson" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Emerson (45) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="emi" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> EMI (176) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="fugoo" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Fugoo (49) </label>
                </div>
              </div>
              ...
              <div class="space-y-2">
                ...
                <div class="flex items-center">
                  ...
                  <label for="fujitsu" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Fujitsu (97) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="fitbit" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Fitbit (56) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="foxconn" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Foxconn (234) </label>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <label for="floston" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Floston (45) </label>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
              <div class="grid grid-cols-2 gap-3">
                ...
                <div class="col-span-2 flex items-center justify-between space-x-2">
                  ...
                  <div class="shrink-0 text-sm font-medium dark:text-gray-600">to</div>
              ...
              <ul class="flex w-full items-center rounded-lg border border-gray-200 bg-white text-sm font-medium text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                <li class="w-full border-r border-gray-200 dark:border-gray-600">
                  <div class="flex items-center pl-3">
                    ...
                    <label for="condition-all" class="ml-2 w-full py-3 text-sm font-medium text-gray-900 dark:text-gray-600"> All </label>
                  </div>
                </li>
                <li class="w-full border-r border-gray-200 dark:border-gray-600">
                  <div class="flex items-center pl-3">
                    ...
                    <label for="condition-new" class="ml-2 w-full py-3 text-sm font-medium text-gray-900 dark:text-gray-600"> New </label>
                  </div>
                </li>
                <li class="w-full">
                  <div class="flex items-center pl-3">
                    ...
                    <label for="condition-used" class="ml-2 w-full py-3 text-sm font-medium text-gray-900 dark:text-gray-600"> Used </label>
                  </div>
                </li>
              </ul>
            </div>
              ...
              <div>
                ...
                <div class="space-y-2">
                  <div class="flex items-center">
                    ...
                    <label for="blue" class="ml-2 flex items-center text-sm font-medium text-gray-900 dark:text-gray-600">
                  ...
                  <div class="flex items-center">
                    ...
                    <label for="gray" class="ml-2 flex items-center text-sm font-medium text-gray-900 dark:text-gray-600">
                  ...
                  <div class="flex items-center">
                    ...
                    <label for="green" class="ml-2 flex items-center text-sm font-medium text-gray-900 dark:text-gray-600">
                  ...
                  <div class="flex items-center">
                    ...
                    <label for="pink" class="ml-2 flex items-center text-sm font-medium text-gray-900 dark:text-gray-600">
                  ...
                  <div class="flex items-center">
                    ...
                    <label for="red" class="ml-2 flex items-center text-sm font-medium text-gray-900 dark:text-gray-600">
                ...
                <div class="space-y-2">
                  ...
                  <div class="flex items-center">
                    ...
                    <label for="four-stars" class="ml-2 flex items-center">
                      ...
                      <svg aria-hidden="true" class="h-5 w-5 text-gray-600 dark:text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <title>Fifth star</title>
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                      </svg>
                    </label>
              ...
              <div>
                ...
                <div class="space-y-2">
                  <div class="flex items-center">
                    ...
                    <label for="under-1-kg" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Under 1 kg </label>
                  </div>
                  ...
                  <div class="flex items-center">
                    ...
                    <label for="1-1-5-kg" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> 1-1,5 kg </label>
                  </div>
                  ...
                  <div class="flex items-center">
                    ...
                    <label for="1-5-2-kg" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> 1,5-2 kg </label>
                  </div>
                  ...
                  <div class="flex items-center">
                    ...
                    <label for="2-5-3-kg" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> 2,5-3 kg </label>
                  </div>
                  ...
                  <div class="flex items-center">
                    ...
                    <label for="over-3-kg" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-600"> Over 3 kg </label>
                  </div>
                </div>
              </div>
            </div>
