...
<div class="max-w-screen-xl mx-auto p-6">
    <h1 class="text-white bg-gray-600 mb-8 text-2xl font-semibold tracking-tight text-heading md:text-2xl lg:text-2xl">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <div>
            <p class="text-white mb-6 text-lg font-normal text-body lg:text-xl">
                Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.
            </p>
            <a href="#" class="inline-flex items-center text-white bg-brand hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-base px-5 py-3 focus:outline-none">
                Learn more
            </a>
            <div class="card mt-4">
   <!-- Card image -->
   ...
   <!-- Card body -->
   <div class="card-body">
    <h4 class="font-semibold">Burnt Ends</h4> class="font-weight-normal mt-3">Card title</h4>
    <p class="text-red card-text mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis non dolore est fuga nobis ipsum illum eligendi nemo iure repellat, soluta, optio minus ut reiciendis voluptates enim impedit veritatis officiis.</p>
    <a href="#" class="btn btn-primary">Go somewhere</a>
   </div>
</div>
        </div>

        <div class="border-l-4 border-brand-medium pl-6">
            <blockquote class="text-yellow-400 text-xl italic font-semibold tracking-tight text-heading">
